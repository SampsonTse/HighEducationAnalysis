...
class DTFX:
    ...
    def ZTGK_CITY_TABLE(self, dsh):
        ...
        sql = "select count(jmx.ksh) from TYMHPT.T_GKPJ2020_TKSTZCJMX jmx right join GKEVA2020.jbxx on jbxx.ksh=jmx.ksh " \
              "where jmx.tzh=3 and jmx.kmh = 006 and jbxx.ds_h=" + dsh
        self.cursor.execute(sql)
        ...
        sql = r"select avg(jmx.zf) from TYMHPT.T_GKPJ2020_TKSTZCJMX jmx " \
              ...
              r"(jbxx.kslb_h=1 or jbxx.kslb_h=3) and jmx.tzh=3 and jmx.kmh = 006"
        self.cursor.execute(sql)
        result.append(self.cursor.fetchone()[0])
        ...
        sql = r"select avg(jmx.zf) from TYMHPT.T_GKPJ2020_TKSTZCJMX jmx " \
              r"right join GKEVA2020.jbxx on jbxx.ksh=jmx.ksh where " \
              r"(jbxx.kslb_h=2 or jbxx.kslb_h=4) and jmx.kmh = 006 and jmx.tzh=3"
        self.cursor.execute(sql)
        result.append(self.cursor.fetchone()[0])
        ...
        sql = r"select avg(jmx.zf) from TYMHPT.T_GKPJ2020_TKSTZCJMX jmx " \
              r"right join GKEVA2020.jbxx on jbxx.ksh=jmx.ksh where " \
              r"(jbxx.kslb_h=1 or jbxx.kslb_h=2) and jmx.kmh = 006 and jmx.tzh=3"
        self.cursor.execute(sql)
        result.append(self.cursor.fetchone()[0])
        ...
        # 计算维度为往届
        sql = r"select count(jmx.zf),avg(jmx.zf),stddev_samp(jmx.zf) from TYMHPT.T_GKPJ2020_TKSTZCJMX jmx " \
              r"right join GKEVA2020.jbxx on jbxx.ksh=jmx.ksh where (jbxx.kslb_h=3 or jbxx.kslb_h=4) and jmx.kmh = 006 " \
              r"and jmx.tzh=3 and jbxx.ds_h=" + dsh
        ...
        sql = r"select avg(jmx.zf) from TYMHPT.T_GKPJ2020_TKSTZCJMX jmx " \
              r"right join GKEVA2020.jbxx on jbxx.ksh=jmx.ksh where (jbxx.kslb_h=3 or jbxx.kslb_h=4) and jmx.kmh = 006 and jmx.tzh=3"
        self.cursor.execute(sql)
        result.append(self.cursor.fetchone()[0])
        ...
        for xqh in xqhs:
            result = []
            sql = r"select count(jmx.zf),avg(jmx.zf),STDDEV_SAMP(jmx.zf) from TYMHPT.T_GKPJ2020_TKSTZCJMX jmx " \
                  r"where jmx.tzh=3 and kmh = 006 and  KSH LIKE '" + str(xqh[0]) + r"%'"
            self.cursor.execute(sql)
            print(sql)
            result = self.cursor.fetchone()
            result = list(result)
    ...
    def GSQKFX_PROVINCE(self):
        ...
        row = []
        # 全省
        sql = r"select count(zf),avg(zf),STDDEV_SAMP(zf) from TYMHPT.T_GKPJ2020_TKSTZCJMX where kmh=006 and tzh=3 "
        self.cursor.execute(sql)
    ...
    def YSFGK_PROVINCE_APPENDIX(self):
        ...
        sql = r"select zf,count(zf) from TYMHPT.T_GKPJ2020_TKSTZCJMX where zf!=0 and kmh=006 and tzh=3 group by zf order by zf desc"
        self.cursor.execute(sql)
